  ...
  > = {
    ...
    [UserRole.CONSUMER]: {
      ...
      prompts: [
        ...
        "How can I check whether an ISI mark on packaged drinking water is genuine?",
        "How to file a consumer grievance against defective ISI certified goods?",
        "What is the difference between BIS Hallmark and 916 purity mark?",
        "Is BIS registration mandatory for smart phones and electronic toys?",
    ...
    [UserRole.STUDENT_RESEARCHER]: {
      ...
      prompts: [
        ...
        "Comparative analysis between IS 456 concrete standards and Eurocode 2",
        "What are the latest amendments to National Building Code (NBC 2016)?",
