      ...
      <section className="relative w-full bg-gradient-to-b from-white via-[#CAF0F8]/50 to-[#ADE8F4]/60 dark:from-[#07111F] dark:via-[#07111F] dark:to-[#0B1A2B] overflow-hidden">
        ...
        <div className="relative pt-12 pb-20 px-4 sm:px-6 max-w-7xl mx-auto w-full text-center">
          ...
          <div className="mt-6 max-w-3xl mx-auto text-left">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-slate-600 dark:text-[#A8B6C7] flex items-center gap-1.5">
            ...
            >
              {currentModeConfig.prompts.map((prompt, idx) => (
                <button
                  ...
                  className="text-xs px-3 py-1.5 rounded-lg bg-white/95 dark:bg-[#10243A] backdrop-blur-xs border border-[#ADE8F4] dark:border-[#263B50] hover:border-[#00B4D8] dark:hover:border-[#16A9D8] text-slate-700 dark:text-[#A8B6C7] hover:text-[#0077B6] dark:hover:text-[#F1F5F9] hover:bg-[#CAF0F8]/40 dark:hover:bg-[#153653] transition-all duration-200 text-left hover:-translate-y-0.5 hover:shadow-xs cursor-pointer"
                >
                  {prompt}
                </button>
              ))}
